...
​     ![](/images/technology/Apache-PHP-MySQL/Apache-PHP-MySQL/vc-redistributable.png)

​    2、下载对应版本的[Apache HTTP SEVER ](https://httpd.apache.org/download.cgi)         
   ![](/images/technology/Apache-PHP-MySQL/Apache-PHP-MySQL/FilesForWindows.png)
   ---
   ![](/images/technology/Apache-PHP-MySQL/Apache-PHP-MySQL/ApacheLounge.png)
   ---
   ![](/images/technology/Apache-PHP-MySQL/Apache-PHP-MySQL/ApacheLoungeAdditional.png)
   ---
   ![](/images/technology/Apache-PHP-MySQL/Apache-PHP-MySQL/httpd-vc14.png)
   ---
   ![](/images/technology/Apache-PHP-MySQL/Apache-PHP-MySQL/httpd-win64-vc14.png)
    3、安装配置Apache
...
![](/images/technology/Apache-PHP-MySQL/Apache-PHP-MySQL/Localhost.png)
...
![](/images/technology/Apache-PHP-MySQL/Apache-PHP-MySQL/past-releases.png)

![](/images/technology/Apache-PHP-MySQL/Apache-PHP-MySQL/php-download.png)
###### 在命令行下运行PHP
...
![](/images/technology/Apache-PHP-MySQL/Apache-PHP-MySQL/cmd-php.png)
...
![](/images/technology/Apache-PHP-MySQL/Apache-PHP-MySQL/php-info.png)

##### 安装、配置[MySQL](https://www.mysql.com/downloads/)

![](/images/technology/Apache-PHP-MySQL/Apache-PHP-MySQL/MySQLCommunity.png)

![/](/images/technology/Apache-PHP-MySQL/Apache-PHP-MySQL/MySQLCommunityServer.png)

![](/images/technology/Apache-PHP-MySQL/Apache-PHP-MySQL/MySQLCommunityArchives.png)
![](/images/technology/Apache-PHP-MySQL/Apache-PHP-MySQL/MySQLCommunityServerZip.png)
...
* 在phpMyAdmin中选择root用户，选择右边的【编辑权限】给用户root设置密码
  ...
  ![](/images/technology/Apache-PHP-MySQL/Apache-PHP-MySQL/edit-root-localhost.png)
...
![](/images/technology/Apache-PHP-MySQL/Apache-PHP-MySQL/WelcomeToWordPress.png)
