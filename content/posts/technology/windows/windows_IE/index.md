...
| <span style="display:inline-block;width=60px">自定义项目(中文)</span> | <span style="display:inline-block;width=30px">注册表项编码</span> | <span style="display:inline-block;width=30px">取值</span> |
| :----------------------------------------------------------: | :----------------------------------------------------------: | :-------------------------------------------------------: |
