...
| <span style="display:inline-block;width:10px">序号</span> | <span style="display:inline-block;width:40px">自定义项目(中文)</span> | <span style="display:inline-block;width:40px">自定义项目(英文)</span> | <span style="display:inline-block;width:40px">编码</span> | <span style="display:inline-block;width:40px">取值</span> |
| :-------------------------------------------------------: | :----------------------------------------------------------: | :----------------------------------------------------------: | :-------------------------------------------------------: | --------------------------------------------------------- |
