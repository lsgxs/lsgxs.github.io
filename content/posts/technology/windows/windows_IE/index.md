...
| 11-ActiveX控件和插件：仅允许经过批准的域在未经提示的情况下使用ActiveX |   Only allow approved domain to use ActiveX without prompt   |                                                           | **0-禁用；1-提示；3-启用**                                 |
...
|     18-ActiveX控件和插件：在ActiveX空间上运行反恶意软件      |         Run antimalware software on ActiveX controls         |                                                           | 0-启用；1-提示；3-禁用                                     |
| 19-ActiveX控件和插件：在没有使用外部媒体播放机的网页上显示视频和动画 | Display video and animation on a webpage that does not use external media player |                                                           | 0-启用；1-提示；3-禁用                                     |
...
|                   26-其他：呈现旧版筛选器                    |                    Render legacy filters                     |                                                           | 0-启用；1-提示；3-禁用                                     |
|                  27-其他：持续使用用户数据                   |                    User data persistence                     |                           1606                            | 0-启用；1-提示；3-禁用                                     |
...
|                 31-其他：跨域浏览窗口和框架                  |     Navigate windows and frames across different domains     |                                                           | 0-启用；1-提示；3-禁用                                     |
|                    32-其他：启用MIME探查                     |                     Enable MIME Sniffing                     |                                                           | 0-启用；1-提示；3-禁用                                     |
|                33-其他：使用SmartScreen筛选器                |                    Use SmartScreen Filter                    |                                                           | 0-启用；1-提示；3-禁用                                     |
...
|         42-其他：允许网页上的活动内容使用限制的协议          | Allow webpages to use restricted protocols for active content |                                                           | 0-启用；1-提示；3-禁用                                     |
