...
| <span style="display:inline-block;width=60px">自定义项目(中文)</span> | <span style="display:inline-block;width=40px">编码</span> | <span style="display:inline-block;width=30px">取值</span> |
| :----------------------------------------------------------: | :-------------------------------------------------------: | --------------------------------------------------------- |
...
根据目前基于IE11的业务需求，只有第11、34两项设置为禁用，其他设置为启用，第四项的".NET Framework-reliant  components---Permissions for components with manifests	"只有禁用和高级安全两个选项，设置为0x000010000（高级安全）。把下面的内容保存为批处理文件(bat)，以管理员权限执行就可以完成IE安全区域注册表项的设置。
...
* 34.Miscellaneous---Use Pop-up Blocker("1809")
   ...
   [SetIeSecurityOpts202308.bat](files/SetIeSecurityOpts202308.bat) 
