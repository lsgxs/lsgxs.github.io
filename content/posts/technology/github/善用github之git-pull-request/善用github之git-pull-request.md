...
![](/images/technology/github/善用github之git-pull-request/善用github之git-pull-request/git-pull-requests-files-changed.png)
...
* 把大佬帮助修改好的仓库项目修改origin 链接，指向第二个github账号fork的仓库。（其实修改的项目已经可以使用，只是我好奇到底是怎么修改的^-^）
  ...
  ![](/images/technology/github/善用github之git-pull-request/善用github之git-pull-request/git-remote-add.png)
  ...
  * 登录github，选择源仓库(也就是Fork到的仓库的源仓库），选择pull request,选择New pull request。下面会显示本次commit所涉及的所有变更明细清单：
    ...
    ![](/images/technology/github/善用github之git-pull-request/善用github之git-pull-request/new-pull-request.png)
  
    ![](/images/technology/github/善用github之git-pull-request/善用github之git-pull-request/new-pull-request-comment.png)
  ...
  ​        ![](/images/technology/github/善用github之git-pull-request/善用github之git-pull-request/new-pull-request-list.png)
