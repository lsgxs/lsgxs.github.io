...
一直可以正常访问自己保存在https://username.github.io的笔记，但是最近几天在虚拟机无法访问了，虚拟机里重新安装Windows10也是无法访问，捣鼓了一天也没有解决。咨询文心一言也是说有可能是电信供应商设置DNS的问题，但是给出的答案并没有彻底解决问题。网上查询，最终使用一条命令解决：
